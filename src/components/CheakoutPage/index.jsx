...
function CheakoutPage() {
  ...
  const getAllAddress = () => {
    axios
      .get(`${PublicBaseUrl}api/user/checkout?token=${auth().access_token}`)
      .then((res) => {
        setSslStatus(
          !!(
            res.data &&
        ...
        if (selectedRule) {
          if (selectPayment) {
            if (selectPayment && selectPayment === "cashOnDelivery") {
              ...
              setStrpLoading(true);
              const url = `${PublicBaseUrl}user/checkout/paypal-react-web-view?token=${
                auth().access_token
              ...
              const url = `${PublicBaseUrl}user/checkout/razorpay-order?token=${
                auth().access_token
              }&shipping_method_id=${parseInt(
                selectedRule
              )}&shipping_address_id=${selectedShipping}&coupon=${
              ...
              await axios
                ...
                .then((res) => {
                  ...
                  if (res.data) {
                    const provideUrl = `${PublicBaseUrl}user/checkout/razorpay-web-view?token=${
                      auth().access_token
                    }&shipping_address_id=${selectedShipping}&coupon=${
                      couponCode && couponCode.code
              ...
              const url = `${PublicBaseUrl}user/checkout/flutterwave-web-view?token=${
                auth().access_token
              }&shipping_method_id=${parseInt(
                selectedRule
              )}&shipping_address_id=${selectedShipping}&coupon=${
              ...
              const url = `${PublicBaseUrl}user/checkout/pay-with-mollie?token=${
                auth().access_token
              }&shipping_method_id=${parseInt(
                selectedRule
              )}&shipping_address_id=${selectedShipping}&coupon=${
              ...
              const url = `${PublicBaseUrl}user/checkout/myfatoorah-webview?token=${
                auth().access_token
              }&shipping_method_id=${parseInt(
                selectedRule
              )}&shipping_address_id=${selectedShipping}&coupon=${
              ...
              const url = `${PublicBaseUrl}user/checkout/pay-with-instamojo?token=${
                auth().access_token
              }&shipping_method_id=${parseInt(
                selectedRule
              )}&shipping_address_id=${selectedShipping}&coupon=${
              ...
              const url = `${PublicBaseUrl}user/checkout/paystack-web-view?token=${
                auth().access_token
              }&shipping_method_id=${parseInt(
                selectedRule
              )}&shipping_address_id=${selectedShipping}&coupon=${
              ...
              const url = `${PublicBaseUrl}user/checkout/sslcommerz-web-view?token=${
                auth().access_token
              }&shipping_method_id=${parseInt(
                selectedRule
              )}&shipping_address_id=${selectedShipping}&coupon=${
